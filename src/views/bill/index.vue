<template>
  <div>
    <div ref="d3" id="d3_ele" style="width: 100vw; height: 400px"></div>
  </div>
</template>
...
const csv_str = `account-account-account-account-account-account,22781
...
export default {
  mounted() {
    ...
    let csv = d3.csvParseRows(csv_str);
